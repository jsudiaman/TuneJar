...
### No Java? No Problem!
TuneJar comes with platform-tailored binaries which can be run without ever installing Java on your machine. Enjoy **full functionality** without any of the hassle.
