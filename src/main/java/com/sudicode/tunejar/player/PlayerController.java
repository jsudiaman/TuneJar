...
public class PlayerController implements Initializable {
   ...
   * @param resources The resources used to localize the root object, or <code>null</code> if the
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    getSongTable().getSelectionModel().selectedItemProperty()
    ...
    getPlaylistTable().getSelectionModel().selectedItemProperty()
        .addListener((observable, oldValue, newValue) -> {
          ...
          setSongList(FXCollections
              .observableArrayList(getPlaylistTable().getSelectionModel().getSelectedItem()));
          getSongTable().setItems(getSongList());
  ...
  public void refreshTables() {
    ...
    List<Playlist> selectedPlaylists =
        new ArrayList<>(getPlaylistTable().getSelectionModel().getSelectedItems());
    List<Song> selectedSongs =
        new ArrayList<>(getSongTable().getSelectionModel().getSelectedItems());
