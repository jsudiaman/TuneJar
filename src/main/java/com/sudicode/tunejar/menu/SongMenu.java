...
public class SongMenu extends PlayerMenu {
  ...
  public void editSong() {
    ObservableList<Song> songsToEdit =
        controller.getSongTable().getSelectionModel().getSelectedItems();
  ...
  public void toNewPlaylist() {
    List<Song> songs =
        new ArrayList<>(controller.getSongTable().getSelectionModel().getSelectedItems());
