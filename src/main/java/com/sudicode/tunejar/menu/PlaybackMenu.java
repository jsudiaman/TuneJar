...
public class PlaybackMenu extends PlayerMenu {
  ...
  public void play() {
    ...
    if (controller.getSongList().isEmpty() || index < 0
        || index >= controller.getSongList().size()) {
  ...
  public void play(int row) {
    try {
      ...
      controller.getStatus()
          .setText("Now Playing: " + controller.getPlayer().getNowPlaying().toString());
  ...
  public void pause() {
    ...
    if (controller.getMenuPause().getText().equals("Pause")) {
      controller.getStatus()
          .setText("Paused: " + controller.getPlayer().getNowPlaying().toString());
      ...
      logger.error("Invalid text for pause button detected, text was: "
          + controller.getMenuPause().getText());
