...
final class SongMenu {
	 ...
	 */
	void toNewPlaylist() {
		List<Song> songs = new ArrayList<Song>(controller.songTable.getSelectionModel().getSelectedItems());
	...
	void removeSong() {
		...
		List<Song> songs = new ArrayList<>(controller.songTable.getSelectionModel().getSelectedItems());
